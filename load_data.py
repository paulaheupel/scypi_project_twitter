...
def load_data_to_df(data_path, cols_delete = []):
    ...
    expects a list of column-names of columns that should be deleted to give to tidy_up_data as second parameter
...
def tidy_up_data(df, cols_delete):
    '''
    expects a dataframe and deletes NaN-columns
    also deletes specified columsn that are not needed
    '''
